...
class UserController extends Controller
{
    ...
    public function userPostsList(Request $request)
    {
        ...
        foreach ($result as $item) {
            ...
            if ($contentType == 0) {
                $viewPost = '<button type="button" class="btn btn-primary viewPost commonViewBtn" data-bs-toggle="modal" data-username=' . $item->user->username . ' data-profile=' . $profile  . ' data-image=' . $firstContent . ' data-desc="' . $item->desc . '" data-postid=' . $item->id . ' rel="' . $item->id . '">
                ...
                $viewPost = '<button type="button" class="btn btn-primary viewVideoPost commonViewBtn" data-bs-toggle="modal" data-username=' . $item->user->username . ' data-profile='. $profile  .' data-userid='. $item->user->id  .' data-image=' . $firstContent . ' data-desc="' . $item->desc . '" data-postid=' . $item->id . ' rel="' . $item->id . '">
                ...
                $viewPost = '<button type="button" class="btn btn-primary viewAudioPost commonViewBtn" data-bs-toggle="modal" data-username=' . $item->user->username . ' data-profile=' . $profile  . ' data-userid=' . $item->user->id  . ' data-audio=' . $firstContent . ' data-desc="' . $item->desc . '" data-postid=' . $item->id . ' rel="' . $item->id . '">
                ...
                $viewPost = '<button type="button" class="btn btn-primary viewDescPost commonViewBtn" data-bs-toggle="modal" data-username=' . $item->user->username . ' data-profile=' . $profile  . ' data-userid=' . $item->user->id  . ' data-desc="' . $item->desc . '" data-postid=' . $item->id . ' rel="' . $item->id . '">
