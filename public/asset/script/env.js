            ...
            const commentHtml = `
              <div class="comment-user-data">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  <a href="${domainUrl}usersDetail/${comment.user.id}" class="d-flex align-items-center justify-content-between text-dark text-decoration-none">
                    <div class="d-flex align-items-center">
                      <div class="post-modal-user-profile mr-2">
                        <img src="${comment.user.profile || "asset/image/default.png"}" alt="" id="user-profile">
                      </div>
                      <div class="comment-user">
                        <div id="comment-user-name">${comment.user.username}</div>
                      </div>
                    </div>
                  </a>
                  <div class="commentDeleteFromAdmin" id="commentDeleteFromAdmin" rel="${comment.id}" data-user_id="${comment.user.id}">
