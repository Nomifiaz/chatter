$(document).ready(function () {
  ...
  $("#remove_in_app_purchase").on("change", function () {
    let removeInAppPurchase = $(this).is(":checked") ? 1 : 0;
    $(this).val(removeInAppPurchase);
    $("#remove_in_app_purchase_hidden").val(removeInAppPurchase);
  });
