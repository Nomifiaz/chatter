               ...
               <div class="card-body">
                  <form id="minuteLimitForm" method="POST">
                     <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label for="minuteLimitInStories" class="form-label">{{ __('createStoryDuration') }} <span class="text-dark opacity-25"> {{ __('minutes') }}</span></label>
                              <input type="number" class="form-control" name="minute_limit_in_creating_story" id="minuteLimitInStories" required="" value="{{ $setting->minute_limit_in_creating_story }}">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label for="minuteLimitInChoosingVideoForStory" class="form-label">{{ __('videoLimitforStories') }} <span class="text-dark opacity-25"> {{ __('minutes') }} </span></label>
                              <input type="number" class="form-control" name="minute_limit_in_choosing_video_for_story" id="minuteLimitInChoosingVideoForStory" required="" value="{{ $setting->minute_limit_in_choosing_video_for_story }}">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label for="minuteLimitInChoosingVideoForPost" class="form-label">{{ __('videoLimitforPosts') }} <span class="text-dark opacity-25"> {{ __('minutes') }} </span></label>
                              <input type="number" class="form-control" name="minute_limit_in_choosing_video_for_post" id="minuteLimitInChoosingVideoForPost" required="" value="{{ $setting->minute_limit_in_choosing_video_for_post }}">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label for="uploadMaxPerPost" class="form-label">{{ __('maxImagesPerPost') }}</label>
                              <input type="number" class="form-control" name="max_images_can_be_uploaded_in_one_post" id="uploadMaxPerPost" required="" value="{{ $setting->max_images_can_be_uploaded_in_one_post }}">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label for="minuteLimitInAudioPost" class="form-label">{{ __('audioLimitforPosts') }} <span class="text-dark opacity-25"> {{ __('minutes') }} </span></label>
                              <input type="number" class="form-control" name="minute_limit_in_audio_post" id="minuteLimitInAudioPost" required="" value="{{ $setting->minute_limit_in_audio_post }}">
                           </div>
                        </div>
                     </div>
                     <div class="modal-footer p-0">
